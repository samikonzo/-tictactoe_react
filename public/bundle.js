...
/******/ 	__webpack_require__.p = "http://localhost:8050/public/";
/******/
...
var React = __webpack_require__(0);
var Game = __webpack_require__(34);
var Chat = __webpack_require__(38);
var Infobar = __webpack_require__(44);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'p',
						null,
						'(click for copy to clipboard)'
					)
				),
				React.createElement(Infobar, { visibility: infobarVisibility }),
				React.createElement(Game, { visibility: gameVisibility }),
				React.createElement(Chat, { visibility: chatVisibility })
			);
		}
	}]);
...
var Game = function (_React$Component) {
	...
	function Game(props) {
		...
		socket.on('place', function (props) {
			_this.placeInCell(props);
		});

		socket.on('nextTurn', function (props) {
			_this.setState(function (prevState) {
				return {
		...
		socket.on('restart', function (props) {
			_this.restartGame(props);
		});

		socket.on('enable', function (yes) {
			if (yes) {
				//enable playground
				_this.setState(function (prevState) {
					enable: true;
		...
		_this.placeInCell = _this.placeInCell.bind(_this);
		_this.endGame = _this.endGame.bind(_this);
		_this.showWinCombination = _this.showWinCombination.bind(_this);
		_this.sendRestartGameRequest = _this.sendRestartGameRequest.bind(_this);
	...
	_createClass(Game, [{
		...
		key: 'placeInCell',
		value: function placeInCell(props) {
		...
		value: function showWinCombination(winArr) {
			var _this3 = this;

			winArr.forEach(function (cell, i) {
				var rowNum = cell[0];
				var cellNum = cell[1];
				var td = _this3.playground.rows[rowNum].cells[cellNum];
				resizeCell(td, i);
			});
		...
		key: 'sendRestartGameRequest',
		value: function sendRestartGameRequest() {
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: 'game ' + gameVisibility },
				React.createElement(Popup, { visible: this.state.popup, status: this.state.popupStatus, onClick: this.sendRestartGameRequest }),
				React.createElement(
					'table',
...
var Popup = function (_React$Component) {
	...
	_createClass(Popup, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: 'playground__popup ' + popupVisibility + ' ' + popupStatus },
				React.createElement(
					'p',
					null,
					text
				...
				React.createElement(
					'button',
					{ className: 'playground__restartBtn ' + restartBtnVisibility, onClick: this.props.onClick },
					' restart game '
				)
			);
		}
...
var ChatInput = __webpack_require__(43);
var l = console.log;
...
var ChatMessages = function (_React$Component) {
	...
	_createClass(ChatMessages, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: 'chat__log', ref: function ref(list) {
...
var ChatMessages = function (_React$Component) {
	...
	_createClass(ChatMessages, [{
		key: 'render',
		value: function render() {
			var fromMe = this.props.fromMe ? 'message--fromMe' : '';
			// no nicknames
			var messageFrom = this.props.fromMe ? 'You' : 'Enemy';
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'message__message-body' },
					this.props.message
				)
			);
		}
